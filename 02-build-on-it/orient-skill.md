...
1. After they’re done, sort it: what goes to Todoist (tasks), what goes to Notion (context), what goes to calendar (events).
1. Process it all silently.
1. Confirm briefly: “Got it. Added [X] tasks, noted [Y] for next time. Anything else?”
